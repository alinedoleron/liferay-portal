...
const MultiPanelSidebar = React.forwardRef(
	({createPlugin, panels, sidebarPanels, variant = 'dark'}, ref) => {
...
MultiPanelSidebar.displayName = 'MultiPanelSidebar';

const MetalMultiPanelSidebarAdapter = getConnectedReactComponentAdapter(
	MultiPanelSidebar
);

export default MetalMultiPanelSidebarAdapter;
export {MultiPanelSidebar};
